...
const Form = styled.form`width: 40%;`;

const Label = styled.label`width: 100%;`;
				...
				<Flex>
					...
					<Label>
						...
						<TextInput
							placeholder="id"
							onChange={(value) =>
								dispatch({ type: 'set', payload: value, path: 'tender.classification.id' })}
						/>
					</Label>
					...
					<Label>
						...
						<TextInput
							...
							onChange={(value) =>
								dispatch({ type: 'set', payload: value, path: 'tender.classification.description' })}
						/>
					</Label>
				</Flex>
